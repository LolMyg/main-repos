...
int main() { //Главная функция, с которой всегда начинается выполнение любой программы на C++
	...
	cout << storona * 4 << endl; //Берет значение из переменной storona, умножает его на 4  и выводит полученный результат
	cout << "area of a square "; //Выводит на экран текст
	cout << storona * storona; //Берет значение из переменной storona, умножает его на самого себя и выводит полученный результат
